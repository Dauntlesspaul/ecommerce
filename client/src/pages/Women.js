...
import { Fourhalf, Fourstar, Threestar, Fivestar } from '../components/Svg';
...
function Women() {
        ...
        const fetchData = async () => {
            try {
              const page = new URLSearchParams(location.search).get('page') || 1;
                const response = await axiosInstance.get(`/women/?page=${page}`);
  ...
  return (
   <>
   <div className='bg-gray-100 shadow-md shadow-gray-300 text-blck text-xl font-bold w-full h-9 lg:h-14 lg:text-2xl grid place-content-center'> Women </div>
    <div className="w-full box-border flex md:mt-5 justify-center">
    <div className="flex flex-wrap w-fit md:w-[600px] lg:w-[800px] justify-center xl:w-[900px]">
